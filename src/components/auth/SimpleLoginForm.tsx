...
export const SimpleLoginForm: React.FC<LoginFormProps> = ({ onSwitchToRegister, onSuccess }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Login and get token
      const authResponse = await simpleAuthService.login(formData);
      setToken(authResponse.access_token);
      
      // Get user info
      const user = await simpleAuthService.getCurrentUser(authResponse.access_token);
      setUser(user);
